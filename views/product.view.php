        ...
        <div class="grid gap-6 grid-cols-5">
          <div class="col-span-3">
            ...
            <div class="relative flex">
              <button
                class="absolute top-0 left-0 h-full text-white bg-black/30 hover:bg-black/50"
              >
                <svg
              ...
              <button
                class="absolute top-0 right-0 h-full text-white bg-black/30 hover:bg-black/50"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="w-8 h-8"
              ...
              <a
                href="#"
                class="flex items-center w-24 h-24 border border-gray-300 border-1 hover:border hover:border-purple-600 transition-colors"
              >
                <img src="/src/img/1_1.jpg" alt="" />
              </a>
              <a
          ...
          <div class="col-span-2">
            ...
            <div class="mb-6 text-xl font-bold">$17.99</div>
            ...
            <div class="mb-6 text-gray-500 wysiwyg-content">
              <table>
                <tbody>
                  <tr>
