<header class="flex justify-between text-white shadow-md bg-slate-800">
      <div>
      ...
      >
        <ul>
          <li>
            <a
              href="/src/index.html"
              class="block px-3 py-2 nav-link transition-colors hover:bg-slate-800"
              >Home</a
            >
          </li>
          <li>
            <a
              href="#"
              class="block px-3 py-2 transition-colors hover:bg-slate-800"
              >Categories</a
            >
          </li>
          <li>
        ...
        <ul>
          ...
          <li class="relative">
            <a
              href="#"
              class="flex items-center justify-between px-3 py-2 hover:bg-slate-800"
            >
          ...
          <li class="px-3 py-3">
            <a
              ...
              class="block w-full px-3 py-2 text-center text-white rounded shadow-md bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 transition-colors"
            >
              Register now
            </a>
          </li>
      ...
      <nav class="hidden md:block">
        <ul class="items-center grid grid-flow-col">
          <li>
            <a
              href="/src/cart.html"
          ...
          <li class="relative">
            <a
              href="#"
              class="flex items-center pr-5 py-navbar-item px-navbar-item hover:bg-slate-900"
            >
              <span class="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <ul class="absolute right-0 z-10 w-48 py-2 bg-slate-800">
              <li>
                <a
                  href="/src/profile.html"
          ...
          <li>
            <a
              href="/src/signup.html"
              class="inline-flex items-center px-3 py-2 mx-5 text-white rounded shadow-md bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 transition-colors"
            >
              Register now
            </a>
          </li>
