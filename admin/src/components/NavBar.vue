<template>
    <header class="flex justify-between items-center p-3 h-14 shadow bg-white">
        <button @click="emit('toggle-sidebar')" class="flex items-center justify-center rounded hover:transition-colors w-8 h-8 text-gray-700 hover:bg-black/10">
            <Bars3Icon class="w-6" />
        </button>
                    ...
                    <MenuItems
                        ...
                        <div class="px-1 py-1">
                            ...
                            <button :class="[
                                ...
                                <UserIcon :active="active" class="mr-4 h-5 w-5 text-indigo-400" aria-hidden="true" />
                                Profile
                            </button>
                            </MenuItem>
                            <MenuItem v-slot="{ active }">
                            <button :class="[
                                ...
                                <ArrowLeftOnRectangleIcon :active="active" class="mr-4 h-5 w-5 text-indigo-400"
                                    aria-hidden="true" />
                                Logout
                            </button>
                            </MenuItem>
