<template>
  <GuestLayout title="Sign In To Your Account">
    ...
    <div v-if="errorMsg" class="flex items-center justify-between py-3 px-5 bg-red-500 text-white rounded">
     {{ errorMsg }} 
    <span @click="errorMsg" class="w-8 h-8 flex items-center justify-center rounded-full transition-color cursor-pointer hover:bg-black/10">
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="text-sm">
          <router-link to="/request-password" class="font-medium text-indigo-600 hover:text-indigo-500">Forgot your
