...
const classes = computed(() =>
    props.active
        ...
        : 'block w-full pl-3 pr-4 py-2 border-l-4 border-transparent text-left text-base font-medium text-gray-200 hover:text-gray-800 hover:bg-slate-300 hover:border-gray-300 focus:outline-none  focus:border-gray-300 transition duration-150 ease-in-out'
);
</script>
